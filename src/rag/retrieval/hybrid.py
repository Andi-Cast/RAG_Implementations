...
def hybrid_retrieve(query: str, k: int = 10, candidate_k: int = 50) -> list[str]:
    ...
    dense_results = naive_dense_retrieve(query, k=candidate_k)
    sparse_results = sparse_retrieve(query, k=candidate_k)
